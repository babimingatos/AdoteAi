                                     ...
                                     <?php
                                        ...
                                        ?>
                                                <div class="col-lg-3 col-md-6 mb-3">
                                                    <div class="card">
                                                    <img class="" width= 100%; height= 150px; src="../assets/imgs/imgOng/<?php echo $rows_ong->ong_img; ?>" alt="ONG's">
                                                        <div class="card-body">
                                                            <a href="ong/pagOng1.php?id=<?php echo $rows_ong->ong_id; ?>" class="text-decoration-none link-dark">
                                                                <h4 class="card-title text-center"><?php echo $rows_ong->ong_nome; ?></h4>
                                                            </a>
                                                        </div>
...
<!-- 
    ...
    <!--CONTATO - COMEÇO -->
    <form action="phpmailerr.php" method="POST">
        <section id="contato" class="mb-5 bg-dark text-light">
            ...
            <h6 class="text-center ">
               ...
               Entre em contato conosco para dúvidas, sugestões, patrocínios, doações entre outros.
            </h6>
    ...
    <script src="https://cdnjs.cloudflare.com/ajax/libs/popper.js/1.14.0/umd/popper.min.js"></script><script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.min.js" integrity="sha384-cVKIPhGWiC2Al4u+LWgxfKTRIcfu0JTxR+EQDz/bgldoEyl4H0zUF0QKbrJ0EcQF" crossorigin="anonymous"></script>
