...
if ($_POST) {
    ...
    include "conexao.php";
    try {
        $st = $conexao->prepare("SELECT * FROM tbl_ong WHERE ong_email=? and ong_senha=?;");
        $st->bindParam(1, $_POST['OOemail']);
        $st->bindParam(2, $_POST['OOsenha']);
        $st->execute();
        if ($rs = $st->fetch(PDO::FETCH_OBJ)) {
            $_SESSION['login'] = $rs->ong_email;
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite o Email">
                                <input class="input100" type="email" name="OOemail">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite a senha">
                                <input class="input100" type="password" name="OOsenha">
                                <span class="focus-input100"></span>
                            </div>
                        </div>

                        <div class="col-lg-12">
                            <div class="container-login100-form-btn m-t-17" type="submit">
