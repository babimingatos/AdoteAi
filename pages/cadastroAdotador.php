...
if ($_POST) {
    include "conexao.php";
    try {
        $st = $conexao->prepare("INSERT INTO tbl_usuario (user_nome, user_cpf,user_telefone,user_endereco,user_numero,user_cep,user_cidade,user_uf,user_bairro,
        user_complemento,user_email,user_senha) VALUES (?,?,?,?,?,?,?,?,?,?,?,?); ");
        $st->bindParam(1, $_POST['Anome']);
        $st->bindParam(2, $_POST['Acpf']);
        $st->bindParam(3, $_POST['Atelefone']);
        $st->bindParam(4, $_POST['Aendereco']);
        $st->bindParam(5, $_POST['Anumero']);
        $st->bindParam(6, $_POST['Acep']);
        $st->bindParam(7, $_POST['Acidade']);
        $st->bindParam(8, $_POST['Auf']);
        $st->bindParam(9, $_POST['Abairro']);
        $st->bindParam(10, $_POST['Acomplemento']);
        $st->bindParam(11, $_POST['Aemail']);
        $st->bindParam(12, $_POST['Asenha']);
        if ($st->execute()) {
            if ($st->rowCount() > 0) {
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite o CPF">
                                <input class="input100" type="number" name="Acpf">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite o Telefone">
                                <input class="input100" type="number" name="Atelefone">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite o Logradouro">
                                <input class="input100" type="text" name="Aendereco">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-2">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite o Numero">
                                <input class="input100" type="number" name="Anumero">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite o CEP">
                                <input class="input100" type="number" name="Acep">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
