      ...
      <div class="container-fluid container">
         ...
         <div class="collapse navbar-collapse" id="navbarScroll">
            <ul class="navbar-nav me-auto my-2 my-lg-0 navbar-nav-scroll" style="--bs-scroll-height: 100px; width:100%;">
               <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="ong/adminong/animaisCadastrados.php">Animais Cadastrados</a>
               </li>
               <li class="nav-item">
                  <a class="nav-link active" aria-current="page" href="ong/adminong/cadastrarAnimal.php">Cadastrar Animais</a>
               </li>
