...
if ($_POST) {
    ...
    include "conexao.php";
    try {
        $st = $conexao->prepare("SELECT * FROM tbl_usuario WHERE user_email=? and user_senha=?;");
        $st->bindParam(1, $_POST['AAemail']);
        $st->bindParam(2, $_POST['AAsenha']);
        $st->execute();
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite o Email">
                                <input class="input100" type="email" name="AAemail">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="wrap-input100 validate-input" data-validate="Digite a senha">
                                <input class="input100" type="password" name="AAsenha">
                                <span class="focus-input100"></span>
                            </div>
                        </div>
