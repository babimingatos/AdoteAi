                ...
                <section class="container ">
                    <div class="row ">
                        ...
                        <div style="margin-top:3cm" class="col-lg-5 col-md-6">
                            <img style="width: 100%;float:right;margin-top:-100px;"
                                src="../../assets/imgs/imgAnimal/<?php echo $row_usuario['ani_img']; ?>">
                        </div>
                        ...
                        <div class="col2-lg-4 col-md-6" style="margin-left: 2cm;">
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">Carteira de vacinação
                                                    </h5>
                                                ...
                                                <div class="modal-body">
                                                    <img class="" width=100%;
                                                        src="../../assets/imgs/imgVacina/<?php echo $row_usuario['ani_vacina']; ?>">
                                                </div>
                            ...
                            <br>
                            <a href="../../chat/index.php" class="btn btn-primary btn-lg active" role="button"
                                aria-pressed="true">Adotar</a>
                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-6 text-end ">
                        ...
                        if ($pagina_anterior != 0) { ?>
                            <a class="btn btn-info mb-3 mr-1"
                                href="../index.php?pagina=<?php echo $pagina_anterior; ?>#pagina_animal" role="button"
                                data-slide="prev">
                        ...
                        for ($i = 1; $i < $num_pagina + 1; $i++) { ?>
                            <button class="btn btn-info mb-3 mr-1"><a class="link-dark"
                                    href="../index.php?pagina=<?php echo $i; ?>#pagina_animal">
                                    <?php echo $i; ?>
                                </a></button>
                        <?php } ?>
                        ...
                        if ($pagina_posterior <= $num_pagina) { ?>
                            <a class="btn btn-info mb-3 "
                                href="../index.php?pagina=<?php echo $pagina_posterior; ?>#pagina_animal" role="button"
                                data-slide="next">
                                        ...
                                        if ($result_animal->execute()) {
                                            while ($rows_animal = $result_animal->fetch(PDO::FETCH_OBJ)) {
                                                ...
                                                <div class="col-lg-3 col-md-6 mb-3">
                                                    <div class="card">
                                                        <img class="" width=100%; height=150px;
                                                            src="../../assets/imgs/imgAnimal/<?php echo $rows_animal->ani_img; ?>"
                                                            alt="Animal">
                                                        <div class="card-body">
                                                            <a href="animal/pagAnimal.php?id=<?php echo $rows_animal->ani_id; ?>"
                                                                class="text-decoration-none link-dark">
                                                                <h4 class="card-title text-center">
                                                                    <?php echo $rows_animal->ani_nome; ?>
                                                                </h4>
                                                            </a>
                                                        </div>
